 ...
 const faq = () => {
  ...
  return (
    ...
    <div style={{marginTop:"5%"}}>
      ...
      <button style={{color:"blue",border:"1px solid blue",width:"12%",borderRadius:"24px",padding:"0.5%",marginTop:"2%",marginLeft:"3%",marginBottom:"7%"}} onClick={handlejob}>View jobs</button>
    </div>
    </div>
