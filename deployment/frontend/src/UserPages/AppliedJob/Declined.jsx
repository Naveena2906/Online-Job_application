...
export const Declined = () => {
  ...
  if (pendingfilter.length === 0) {
    return (
      ...
      <div className="appliedjobbody pt-[100px] w-[80%] ml-[180px]">
        <h2 className='text-2xl font-bold ml-[33%] mt-[40px] pb-[30px]'>No Declined Applications 🙂</h2>
        <AppliedNavbar />
  ...
  return (
    ...
    <UserNavbar/>
        <div className="appliedjobbody pt-[100px] w-[80%] ml-[180px]"> 
        <h2 className='text-2xl font-bold ml-[33%] mt-[40px] pb-[30px]'>Oops! <span className='text-red-500'>Declined</span> Applications 😞</h2>
