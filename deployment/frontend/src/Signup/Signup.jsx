...
export const Signup = () => {
    ...
    const handleChange=(e)=>{
      ...
      const handleSubmit=async(e)=>{
        e.preventDefault();
        try {
            if(signup.username===''||signup.email===''||signup.mobilenum===''||signup.password==='')
            {
  ...
  return (
    ...
    />
        ...
        <h3 className='text-2xl font-semibold mt-[-10px]'><span>Welcome to </span> Career<span className='text-blue-500'>Craft</span></h3>
