  ...
  return (
    ...
    />
        <div className="logintop mt-[42px] h-[563px]">
            ...
            <div className="loginleft w-[500px] ml-[370px] mt-[40px] ">
        ...
        <div className="loginbox items-center w-[35%] ml-[48%] mt-[-26%] h-[340px]  ">
            ...
            <button  className="lbut mt-4" onClick={handleSubmit}>Login</button>
            <h3 className='font-semibold mt-6 w-[300px] ml-[125px]' >New user ? <span className='text-1xl font-semibold text-blue-700' style={{cursor:'pointer'}} onClick={()=>{navigate('/signup')}}>Create One</span></h3>
            </div>
            <h3 className='text-1xl font-semibold ml-[400px] mt-[50px]'><span className="text-1xl font-bold">Note : </span>All your details are stored securely and are visible only to the verified recruiters. </h3>
        </div>
  )
}
