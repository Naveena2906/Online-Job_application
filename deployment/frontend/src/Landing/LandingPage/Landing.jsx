      ...
      <div>
        ...
        <div className='land'>
          <div >
           ...
           <div style={{color:"white",marginLeft:"50%",cursor:"pointer",marginTop:"-4%"}} onMouseEnter={() => handleHover("categories", setShowCategories)} onMouseLeave={() => handleMouseLeave(setShowCategories)}  onClick={() => setShowCategories(!showCategories)}>Jobs </div>
           {showCategories  && (
          <div style={{
            position: 'absolute',
            top: '6%',
          ...
          }} onMouseEnter={() => handleHover("categories", setShowCategories)} 
          onMouseLeave={() => handleMouseLeave(setShowCategories)}>
            ...
            {jobsInDemand.map((category, index) => (
              <div
                key={index}
           ...
           <div style={{color:"white",marginLeft:"2%",cursor:"pointer",marginTop:"-3.7%"}} onMouseEnter={() => handleHover("category", setShowCategorie)} onMouseLeave={() => handleMouseLeave(setShowCategorie)} onClick={() => setShowCategorie(!showCategorie)}>Companies</div>
          ...
          <div style={{
            ...
            width:"25%",
            gridTemplateColumns: '50% 50%',
          }}  onMouseEnter={() => handleHover("category", setShowCategorie)} 
          onMouseLeave={() => handleMouseLeave(setShowCategorie)}>
            <div style={{ padding: '5px' }}>
           ...
           <div style={{color:"white",marginLeft:"2% ",cursor:"pointer",marginTop:"-3.5%"}} onMouseEnter={() => handleHover("service", setShowService)} onMouseLeave={() => handleMouseLeave(setShowService)} onClick={() => setShowService(!showService)}>Services</div>
           {showService && (
          <div style={{
            position: 'absolute',
            top: '7%',
            ...
            width:"23%",
            gridTemplateColumns: '50% 50%',
          }} onMouseEnter={() => handleHover("service", setShowService)}
          onMouseLeave={() => handleMouseLeave(setShowService)}>
            <div style={{ padding: '5px' }}>
