...
const editjob = (jid, prod) =>
  axios.put(`${URI}/auth/update/${jid}`, prod, { headers });
const deletejob = (jid) =>
  axios.delete(`${URI}/auth/delete/${jid}`, { headers });

const addskills = (prod) =>
  axios.post(`${URI}/auth/postskill`, prod, { headers });
const addexperiences = (prod) =>
  axios.post(`${URI}/auth/postexperience`, prod, { headers });
...
const addadminjob = (job) =>
  axios.post(`${URI}/auth/addadminjobs`, job, { headers });
const editadminjob = (id, job) =>
  axios.put(`${URI}/auth/updateadminjob/${id}`, job, { headers });
const deleteadminjob = (id) =>
  axios.delete(`${URI}/auth/deleteadminjob/${id}`, { headers });
