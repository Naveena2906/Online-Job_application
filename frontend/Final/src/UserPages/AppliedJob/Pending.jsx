...
export const Pending = () => {
  ...
  if (pendingfilter.length === 0) {
    return (
      ...
      <h2 className='text-2xl font-bold ml-[40%] mt-[50px] pb-[30px]'>Stay! <span className='text-yellow-600'>Pending</span> Applications 🙂</h2>
        <AppliedNavbar/>
  ...
  return (
    ...
    <UserNavbar/>
        <div className="appliedjobbody pt-[100px] w-[80%] ml-[180px]"> 
        <h2 className='text-2xl font-bold ml-[33%] mt-[50px] pb-[30px]'>Stay! <span className='text-yellow-600'>Pending</span> Applications 🙂</h2>
